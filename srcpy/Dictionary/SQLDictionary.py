...
def _getCreateTableQuery(title):
	switcher = {
		...
		'KTPTDOT': "CREATE TABLE KTPTDOT(FEVALOR DEC(8,0), CDPRODTE CHAR(10), CDPRODCO CHAR(10), TCNUMVER DEC(4), CDPLAN CHAR(5), CDREGION CHAR(8), CDCOAINT CHAR(1), CDDEDUCI CHAR(4), EDAD DEC(5,0), VACOANAC DEC(17,3), VACOAINT DEC(17,3), VAFCTTAR DEC(15,3), VACOASVI DEC(17,3))",
